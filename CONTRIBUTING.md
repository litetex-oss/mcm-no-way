...
## Releasing [![Build](https://img.shields.io/github/actions/workflow/status/litetex-oss/mcm-no-way/release.yml?branch=master)](https://github.com/litetex-oss/mcm-no-way/actions/workflows/release.yml)

Before releasing:
* Consider doing a [test-deployment](https://github.com/litetex-oss/mcm-no-way/actions/workflows/test-deploy.yml?query=branch%3Adev) before actually releasing.
